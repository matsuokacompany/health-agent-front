...
import { OnboardingChecklist } from '@/components/professional/OnboardingChecklist';
...
export default function Patients() {
  ...
  return <>
    ...
    {isProfessional ? <OnboardingChecklist patientCount={(data ?? []).length} onAddPatient={() => setNewPatientOpen(true)} /> : null}
