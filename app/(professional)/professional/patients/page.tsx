...
export default function Patients() {
  ...
  return <>
    ...
    <header className="page-header"><div><span className="eyebrow">Acompanhamento</span><h1>Pacientes em acompanhamento</h1><p className="muted">Acompanhe pacientes vinculados aos seus planos ativos e acesse dashboard, anamnese, check-ins e relatório com IA.</p></div>{isProfessional ? <div className="page-actions"><button type="button" onClick={() => setNewPatientOpen(true)}>Novo paciente</button></div> : null}</header>
