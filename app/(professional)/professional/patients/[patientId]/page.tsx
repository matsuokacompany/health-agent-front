...
function TabPanelSkeleton({ tab }: { tab: PatientDetailTab }) {
  if (tab === 'checkins') return <section className="card patient-table-section professional-detail-section">
