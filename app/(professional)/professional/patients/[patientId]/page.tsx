...
const patientDetailTabs: Array<{ id: PatientDetailTab; label: string; description: string; icon: string }> = [
  { id: 'overview', label: 'Visão geral', description: 'Plano, adesão e situação de hoje', icon: '📋' },
  { id: 'checkins', label: 'Check-ins', description: 'Histórico e sintomas', icon: '💬' },
  { id: 'clinical', label: 'Dados clínicos', description: 'Anamnese e imagens', icon: '🩺' },
  { id: 'reports', label: 'Relatórios IA', description: 'Análises de apoio clínico', icon: '✨' },
];
