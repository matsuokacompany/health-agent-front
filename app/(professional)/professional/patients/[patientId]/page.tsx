...
const patientDetailTabs: Array<{ id: PatientDetailTab; label: string; description: string; icon: ReactNode }> = [
  { id: 'overview', label: 'Visão geral', description: 'Plano, adesão e situação de hoje', icon: <ClipboardText aria-hidden="true" weight="bold" /> },
  { id: 'checkins', label: 'Check-ins', description: 'Histórico e sintomas', icon: <ChatCircleText aria-hidden="true" weight="bold" /> },
  { id: 'clinical', label: 'Dados clínicos', description: 'Anamnese e imagens', icon: <Stethoscope aria-hidden="true" weight="bold" /> },
  { id: 'reports', label: 'Relatórios IA', description: 'Análises de apoio clínico', icon: <Sparkle aria-hidden="true" weight="bold" /> },
];
