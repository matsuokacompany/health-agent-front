...
export default function Calendar() {
  const { reports, loading, updateReport, removeReport } = usePatientData();
  ...
  const selected = useMemo(() => selectedId ? reports.find((report) => report.id === selectedId) : undefined, [reports, selectedId]);
