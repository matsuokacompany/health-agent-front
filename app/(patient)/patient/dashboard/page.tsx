...
export default function PatientDashboard() {
  ...
  return <><PageHeader eyebrow="Portal do paciente" title={`Olá, ${user?.name ?? 'paciente'}`} description="Dashboard temporário com dados derivados dos check-ins até o backend de métricas ficar disponível." action={<Button href="/patient/monitoring">Abrir monitoramento</Button>} />
