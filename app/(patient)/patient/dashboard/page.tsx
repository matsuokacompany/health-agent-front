...
export default function PatientDashboard() {
  ...
  return <><PageHeader eyebrow="Portal do paciente" title={`Olá, ${user?.name ?? 'paciente'}`} description="Acompanhe seus check-ins em um só lugar. O calendário é a principal área para revisar dias respondidos, pendentes e incompletos." action={<Button href="/patient/calendar">Abrir calendário</Button>} />
