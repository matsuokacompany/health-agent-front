...
function normalizeEditForm(report: DailyReport): EditFormState {
  return {
    ...
    medication_adherence: Boolean(report.medication_adherence),
  ...
  async function submitEdit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      const payload = {
        ...
        medication_adherence: editForm.medication_adherence,
