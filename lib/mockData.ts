...
export const mockUsers: User[] = [
  ...
  { id: 'pro1', role: 'professional', email: 'dr@example.com', name: 'Dra. Silva', linkedPatientIds: ['p1', 'p2'], consent: { user_id: 'pro1', accepted_at: '2026-06-01T10:00:00Z', version: '2026-01' } },
...
export const mockPatients: PatientProfile[] = [
  { ...(mockUsers[0] as User), age: 34, diagnosis: 'Monitoramento pós-operatório', lastCheckIn: '2026-06-19', riskLevel: 'moderado' },
  { ...(mockUsers[1] as User), age: 58, diagnosis: 'Controle cardiometabólico', lastCheckIn: '2026-06-18', riskLevel: 'alto' },
];
