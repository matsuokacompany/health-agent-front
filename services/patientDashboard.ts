...
export type PatientDashboardCalendarDay = { date: string; status?: string; has_checkin: boolean; completed: boolean; pending: boolean; has_symptoms: boolean; had_symptoms?: boolean | null; diet_followed: boolean; medication_taken: boolean; checkins: DashboardCheckIn[] };
