...
type SharedHeaderProps = HeaderProps & { isDark: boolean; toggleTheme: () => void; showSearch: boolean; isPatientPortal: boolean };
...
export function AppHeader({ title, onMenuClick, links }: HeaderProps) {
  ...
  const isPatientPortal = pathname.startsWith('/patient');
  ...
  return <header className="app-header responsive-app-header"><DesktopTabletHeader title={title} links={links} isDark={isDark} toggleTheme={toggleTheme} showSearch={showSearch} isPatientPortal={isPatientPortal} /><MobileHeader title={title} onMenuClick={onMenuClick} isDark={isDark} toggleTheme={toggleTheme} showSearch={showSearch} isPatientPortal={isPatientPortal} /></header>;
}
